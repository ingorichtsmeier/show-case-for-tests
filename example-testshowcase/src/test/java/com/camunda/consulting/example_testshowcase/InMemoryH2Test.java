...
public class InMemoryH2Test {
  ...
  private static final String PROCESS_DEFINITION_KEY = "example-testshowcase";
  ...
  public void testHappyPath() {
	  ...
	  assertThat(processInstance).isWaitingAt("UserTask1Task").task().hasName("user task 1");
	  complete(task());
	  assertThat(processInstance).isWaitingAt("UserTask2Task").task().hasName("user task 2");
